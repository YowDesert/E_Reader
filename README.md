...
待做功能:
幫我把我資料夾的程式修好 現在他左邊如果點開子資料夾無法正確顯示 只顯示載入中... 然後就縮回去了 不會顯示左邊的資料夾裡面的資料 順便幫我在檔案管理的左上角新增檔案匯入功能 pdf就匯入pdf檔 圖片就選擇匯入圖片資料夾Edit我來幫你檢查和修復資料夾的程式問題。首先讓我看看你目前的文件結構和程式碼。
